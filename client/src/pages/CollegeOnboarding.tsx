...
export default function CollegeOnboarding() {
  ...
  const updatePathMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast({ title: "Academic path saved", description: "Your selections have been saved. Welcome!" });
      ...
      <div className="max-w-2xl w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">
            Set up your academic path to personalize your experience.
          </p>
        </div>
                  ...
                  <div className="space-y-3">
                    {universities?.map((uni) => (
                      <button
                        ...
                        data-testid={`university-option-${uni.id}`}
                      >
            ...
            <>
              ...
              <CardContent>
                  ...
                  <div className="space-y-3">
                    {majorsData.map((major) => (
                      <button
                        ...
                        data-testid={`major-option-${major.id}`}
                      >
                ...
                <div className="mt-6 pt-6 border-t">
                  ...
                  >
                    {updatePathMutation.isPending ? "Saving..." : "Continue to Dashboard"}
                  </Button>
                </div>
              </CardContent>
            </>
