...
export default function Library() {
  ...
  return (
    // 🔥 شلنا الـ DashboardLayout وحطينا container عادي عشان تبين صفحة عامة
    <div className="max-w-7xl mx-auto space-y-8 p-4 md:p-8 mt-6">
            ...
            <Card key={book.id} className="group hover:shadow-lg transition-all duration-300 border-primary/10 overflow-hidden flex flex-col">
              ...
              <CardContent className="p-5 flex flex-col flex-1">
                ...
                <div className="flex items-center justify-between mt-auto pt-4 border-t">
                  ...
                  {/* هاد الزر بودي الطالب على صفحة الكورس (قبل الشراء) زي ما طلبت */}
